...
// Mock fetch for Node environment if needed, but Node 18 has it global
// If running in environment without fetch, we might need a polyfill or use axios if available
